...
La salida conserva los metadatos XMLTV de EPGShare y añade dos canales:
TeleamazonasQuito.ec y TeleamazonasGuayaquil.ec.
"""
...
def fetch_text(url: str, *, timeout: int = 120) -> str:
    ...
    # Se intenta UTF-8 y luego codificaciones occidentales de respaldo.
...
<body>
  ...
  <p>Incluye Teleamazonas Quito y Teleamazonas Guayaquil.</p>
